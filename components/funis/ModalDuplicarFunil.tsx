  ...
  return (
    <Dialog open={aberto} onOpenChange={v => !v && onFechar()}>
      <DialogContent className="bg-gray-900 border-gray-700 text-white max-w-md">
        ...
        <div className="mt-1 p-3 bg-gray-800/60 rounded-lg border border-gray-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 -mt-2">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              required
              className="bg-gray-800 border-gray-700 text-white placeholder-gray-600 focus:border-indigo-500"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm text-white focus:outline-none focus:border-indigo-500 h-10"
            >
          ...
          <label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg border border-gray-700 hover:border-gray-600 transition-colors">
            <input
              type="checkbox"
