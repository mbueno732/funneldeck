        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="Ex: MVA"
                className="bg-gray-800 border-gray-700 text-white placeholder-gray-600 focus:border-indigo-500 font-mono"
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <select value={form.tipo} onChange={e => handleCampoGatilho('tipo', e.target.value)} required className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white text-sm focus:outline-none focus:border-indigo-500">
            ...
            <div className="space-y-1.5">
              ...
              <select value={form.status} onChange={e => set('status')(e.target.value)} className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white text-sm focus:outline-none focus:border-indigo-500">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input value={form.responsavel_cro} onChange={e => set('responsavel_cro')(e.target.value)} placeholder="Nome" className="bg-gray-800 border-gray-700 text-white placeholder-gray-600 focus:border-indigo-500" />
            </div>
            <div className="space-y-1.5">
              <Label className="text-gray-400 text-xs">Responsável Dev</Label>
              <Input value={form.responsavel_dev} onChange={e => set('responsavel_dev')(e.target.value)} placeholder="Nome" className="bg-gray-800 border-gray-700 text-white placeholder-gray-600 focus:border-indigo-500" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input type="date" value={form.data_ativacao} onChange={e => set('data_ativacao')(e.target.value)} className="bg-gray-800 border-gray-700 text-white focus:border-indigo-500" />
            </div>
            <div className="space-y-1.5">
              <Label className="text-gray-400 text-xs">Planilha de Leads</Label>
              <Input type="url" value={form.planilha_leads} onChange={e => set('planilha_leads')(e.target.value)} placeholder="https://" className="bg-gray-800 border-gray-700 text-white placeholder-gray-600 focus:border-indigo-500" />
            </div>
          </div>
